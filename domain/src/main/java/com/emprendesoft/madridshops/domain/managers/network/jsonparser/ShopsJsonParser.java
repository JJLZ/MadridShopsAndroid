package com.emprendesoft.madridshops.domain.managers.network.jsonparser;

import com.emprendesoft.madridshops.domain.managers.network.entities.ShopEntity;
import com.emprendesoft.madridshops.domain.managers.network.entities.ShopsResponseEntity;
